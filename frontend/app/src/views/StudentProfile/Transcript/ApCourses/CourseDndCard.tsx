...
import { EditApCourseModal } from "./EditApCourseModal"
    ...
    <>
      ...
      >
        ...
        <img
          src={EditIcon}
          alt="hamburger-icon"
          onClick={() => dispatch(actions.toggleEditApCoursesModal(course.id))}
        />
      </div>
      <EditApCourseModal
        id={course.id}
        toggle={() => dispatch(actions.toggleEditApCoursesModal(0))}
