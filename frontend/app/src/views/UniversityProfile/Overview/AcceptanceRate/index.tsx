...
const AcceptanceRate: React.VFC<AcceptanceRateProps> = ({
  acceptanceRate,
  onEdit,
}) => {
        ...
        datasets: [
          {
            data: [
              acceptanceRate / 100,
              acceptanceRate !== 100 ? 1 - acceptanceRate / 100 : null,
  ...
  return (
    <MDBCard>
      <MDBCardBody>
        <MDBCardTitle>
          {t(`profile.university.overviewScreen.acceptanceRate`)}
        ...
        <MDBCardText>
          <div className={Styles.container}>
            ...
            <h3 className={Styles.label}>{acceptanceRate.toFixed(0)}%</h3>
          </div>
        </MDBCardText>
      </MDBCardBody>
    </MDBCard>
